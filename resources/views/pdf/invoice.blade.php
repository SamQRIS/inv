    ...
    <div class="page">
        ...
        <div class="header">
            ...
            <div class="invoice-title">
                ...
                <div class="invoice-date">{{ $transaction->transaction_date->locale('id')->translatedFormat('d F Y') }}</div>
            </div>
        </div>
        ...
        <!-- Footer Signatures -->
        <!-- <table style="width:100%; padding-top:2px; margin-top:5px;">
            <tr>
                {{-- Tanda Tangan --}}
                <td style="width:56%; vertical-align:top;">
                    <table style="width:100%;">
                        <tr>
                            <td style="width:30%; text-align:center; vertical-align:top; padding:0 3px;">
                                <div style="font-size:11px; font-weight:bold; padding-bottom:35px;">Dibuat Oleh</div>
                                <div style="border-top:0.7px solid #000; padding-top:2px; font-size:11px; color:#444;">{{ $transaction->user->name }}</div>
                            </td>
                            <td style="width:30%; text-align:center; vertical-align:top; padding:0 3px;">
                                <div style="font-size:11px; font-weight:bold; padding-bottom:35px;">Diterima Oleh</div>
                                <div style="border-top:0.7px solid #000; padding-top:2px; font-size:11px;">{{ $transaction->customer?->name}}</div>
                            </td>
                        </tr>
                    </table>
                </td>
